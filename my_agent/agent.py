...
# Agent Interaction – returns the final response text
async def call_agent(query: str) -> str:
    """Call the root agent with the given user query and return the final response text."""
    ...
    async for event in events:
        if event.is_final_response():
            # Take the first text part as the final answer
